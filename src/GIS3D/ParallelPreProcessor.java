 ...
 * @author Amir72c
 */
public class ParallelPreProcessor extends ParallelProcessor{
    PreProcessor myParent;
    AllData myAllData;
    int myRefinedDataNumber=0;
    ParallelPreProcessor(PreProcessor parent,AllData allData,int startIndex,int endIndex)
    {
        ...
        myThread=new Thread(new Runnable() {
            ...
            public void run() {
                ...
                {
                    myRefinedDataNumber=myParent.parallelInternalProcess(myAllData, i,myRefinedDataNumber);
