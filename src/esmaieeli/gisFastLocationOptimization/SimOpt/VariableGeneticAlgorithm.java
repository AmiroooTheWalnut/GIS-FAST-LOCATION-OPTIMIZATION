...
public class VariableGeneticAlgorithm {
     ...
     * 
     */
    public VariableGeneticAlgorithm(MainFramePanel parent, int passed_numPop, int passed_numGen, float passed_mutatePercent, float passed_internalMutatePercent, float passed_elitPercent, float passed_initLengthPercentToMaxLength) {
        myParent = parent;
    ...
    public VariableGeneticAlgorithm(MainFramePanel parent, int passed_numPop, int passed_numGen, float passed_mutatePercent, float passed_internalMutatePercent, float passed_elitPercent, float passed_initLengthPercentToMaxLength, String layerName) {
        myParent = parent;
        numPop = passed_numPop;
        numGen = passed_numGen;
