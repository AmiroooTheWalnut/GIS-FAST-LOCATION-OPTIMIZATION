...
public class NumericController extends javax.swing.JDialog {
     ...
     */
    public NumericController(java.awt.Window window, MainFramePanel parent, ModalityType modal) {
        super(window, modal);
        initComponents();
        myParent = parent;
...
//        myParent.preProcessor.setWaysColor(myParent.allData, 1);
    ...
    public class CustomjSlider extends JSlider {
        ...
        public CustomjSlider() {
            ImageIcon temp = new javax.swing.ImageIcon(getClass().getResource("/esmaieeli/gisFastLocationOptimization/GUI/hue1.jpg"));
            img = temp.getImage();
        }
...
//        myParent.allData.setParallelLayers(1,-1);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        autoFolderReader = new AutoFolderReader((JFrame) SwingUtilities.getWindowAncestor(this), ModalityType.APPLICATION_MODAL);
