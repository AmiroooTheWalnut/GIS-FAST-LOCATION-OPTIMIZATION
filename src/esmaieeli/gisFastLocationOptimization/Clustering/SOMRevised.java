 ...
 * @version $Revision: 4 $
 */
public class SOMRevised extends AbstractClusterer
    ...
    public void buildClusterer(Instances data) throws Exception {
        ...
        {
            for(int j=0;j<m_instances.instance(i).numAttributes();j++)
            {
//                System.out.println("---");
//                System.out.println(m_instances.instance(i).value(j));
//                System.out.println("Weight: "+m_instances.instance(i).weight());
//                m_instances.instance(i).setValue(j, m_instances.instance(i).value(j)*m_instances.instance(i).weight());
//                System.out.println(m_instances.instance(i).value(j));
//                System.out.println("---");
            }
        }
