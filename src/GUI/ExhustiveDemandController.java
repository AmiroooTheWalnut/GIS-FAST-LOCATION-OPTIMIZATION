...
public class ExhustiveDemandController extends javax.swing.JDialog {
     ...
     */
    public ExhustiveDemandController(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//                                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExhustiveDemandController.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ExhustiveDemandController dialog = new ExhustiveDemandController(new javax.swing.JFrame(), true);
